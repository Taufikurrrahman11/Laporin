...
<section class="content">
    <div class="box">
        <div class="box-header">
            ...
            <a href="<?=site_url('productivity')?>" class="btn btn-warning btn-flat">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <form action="<?=site_url('productivity/process')?>" method="post">
                        ...
                        <div class="form-group">
                            <label>Start *</label>
                            <input type="start" name="start" value="<?=date('Y-m-d')?>" class="form-control" required>
                        </div>
                        <div class="form-group">
