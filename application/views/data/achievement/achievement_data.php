                ...
                <?php $no = 1;
                    foreach($row->result() as $key => $data) {?>
                        ...
                        <td class="text-center" width="160px">
                            <a href="<?= site_url('achievement/edit/' . $data->target_id) ?>" class="btn btn-primary btn-xs">
                                <i class="fa fa-pencil"></i> Update
                            </a>
                            <a href="<?= site_url('achievement/del/' . $data->target_id) ?>" onclick="return confirm('Anda yakin ingin menghapus data?')" class="btn btn-danger btn-xs">
